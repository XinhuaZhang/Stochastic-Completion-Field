...
InitScale=1 #0.149
STDR2=2 #7.295125 #0.0078125 #0.015625 #0.015625
STDTheta=0.5 #7.295125
STDR=0.5
S=1
HistFileName=${ThetaSigma}_${ScaleSigma}_0_${Tau}_${PhiFreqs}_${RhoFreqs}_${ThetaFreqs}_${ScaleFreqs}_${InitScale}_${Size}_${Delta}_${PeriodR2}_${Threshold}_${S}_${STDR2}.dat
...
WriteFlag=True
Iterations=10
Circle="(Circle{circleNum=8,circleRadius=40})"
